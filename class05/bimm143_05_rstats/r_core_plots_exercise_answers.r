...
setwd("~/R/BIMM_143/bimm143_05_rstats/")
...
barplot(feature.counts$Count,
        ...
        horiz = TRUE,
        ylab = "A Title",
        main = "Feature Counts in GRCm38 genome",
        las=1)

hist(c(rnorm(10000),rnorm(10000)+4),breaks=50, main = "Historgram of Normal Distribution")
